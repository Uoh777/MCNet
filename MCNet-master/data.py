...
class SalObjDataset(data.Dataset):
    def __init__(self, train_root, trainsize):
        ...
        self.body_root   = train_root + '/skeleton/'
        self.detail_root = train_root + '/contour/'
...
def get_loader(train_root, batchsize, trainsize, shuffle=True, num_workers=12, pin_memory=True):
