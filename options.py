...
parser.add_argument('--train_data_root', type=str, default='./data/VT5000/Train', help='the training datasets root')
parser.add_argument('--test_data_root', type=str, default='./data/VT5000/Test', help='the testing datasets root')
parser.add_argument('--save_path', type=str, default='./res/', help='the path to save models and logs')
parser.add_argument('--test_model', type=str, default='./res/MCNet_epoch_best.pth', help='saved model path')
